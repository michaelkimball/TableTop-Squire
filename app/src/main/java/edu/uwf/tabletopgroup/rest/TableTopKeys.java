...
public class TableTopKeys {
    ...
    public static final String KEY_PLAYER_LIST = "players";
    public static final String KEY_PLAYER_NAME = "playerName";
    public static final String KEY_MESSAGE = "message";
    public static final String ACTION_MESSAGE_RECEIVED = "edu.uwf.tabletopgroup.MESSAGE_RECEIVED";
    public static final String ACTION_SEND_MESSAGE_TO_ROOM = "edu.uwf.tabletopgroup.SEND_MESSAGE";
    ...
    public static final String ACTION_PLAYER_JOINED = "edu.uwf.tabletopgroup.PLAYER_JOINED";
    public static final String ACTION_INVITE_PLAYER_NAME = "edu.uwf.tabletopgroup.INVITE_PLAYER_NAME";
    public static final String ACTION_GAME_INVITE = "edu.uwf.tabletopgroup.GAME_INVITE";
}
